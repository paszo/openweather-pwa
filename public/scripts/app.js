...
function renderForecast(card, data) {
  ...
  if (lastUpdated >= data.currently.time) {
    console.log('last updated > data currently time');
    return;
  }
  ...
  // const forecastFrom = data.currently.time;
  // console.log('forecastFrom', forecastFrom);
  // console.log('forecastFrom date', forecastFrom);
